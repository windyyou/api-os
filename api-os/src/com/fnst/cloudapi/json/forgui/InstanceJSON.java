...
public class InstanceJSON {
	...
	class Server{
		...
		public Server(String name,String imageRef,String flavorRef,String key_name,String availability_zone,Integer min_count,Integer max_count){
			this.name = name;
		...
		public void setMetadata(List<String> metadataValues) {
			if(null == metadataValues || 1 != metadataValues.size())
				return;
...
//    private String tenant_id;
    ...
    public InstanceJSON(String name,String imageRef,String flavorRef,String key_name,String availability_zone,Integer min_count,Integer max_count){
    	this.server = new Server(name,imageRef,flavorRef,key_name,availability_zone,min_count,max_count);
    }
